...
## Bilag 7–15: Modeludvikling og evaluering
...
- **Bilag 8:** Top 10 vigtigste variabler pr. model  
  ![](images/4_top_10_variabler_pr_model.png){ width=80% fig-align="center" }
  
  
- **Bilag 9:** Sammenlignende heatmap over modeller
  ![](images/3_heatmap_pr_model.png){ width=80% fig-align="center" }
  
- **Bilag 10:** Udvikling over tid – churn-risiko
  ![](images/2_linje_plot.png){ width=80% fig-align="center" }
	
- **Bilag 11:** Brancher med højest churn-rate
  ![](images/5_brancher_højeste_churn.png){ width=80% fig-align="center" }
  
- **Bilag 12:** Postnumre med højest churn-rate
  ![](images/6_postnummer_højeste_churn.png){ width=80% fig-align="center" }

- **Bilag 13:** Top 5 segmenter som ikke churner
  ![](images/7_top5_der_ikke_churner.png){ width=80% fig-align="center" }

- **Bilag 14:** Churn-risikokategorier for aktive kunder
  ![](images/9_churn_risikokategorier_aktive.png){ width=80% fig-align="center" }

- **Bilag 15:** Top 10 variable i Random Forest modellen
  ![](images/8_top_10_variable_rf.png){ width=80% fig-align="center" }
