...
![Fordeling af churn-risiko blandt aktive medlemmer baseret på modelprediktioner. Kategorierne “høj risiko” og "moderat risiko" rummer 38 virksomheder. De udgør et vigtigt proaktivt fokuspunkt.](images/9_churn_risikokategorier_aktive.png){ width=80% fig-align="center" }

# Anvendelse af dashboard i medlemsarbejdet

Som led i samarbejdet med Business Viborg har vi udviklet et interaktivt dashboard, der omsætter churn-modellens output til konkret medlemsindsigt. Dashboardet er målrettet konsulenterne og ledelsen og gør det muligt at identificere medlemmer med høj risiko for at opsige deres medlemskab. Derudover kan den enkelte virksomhed analyseres i dybden med forslag til kontakt og opfølgning. Visualiseringen er designet til at passe ind i konsulenternes arbejdsgange og skabe et klart beslutningsgrundlag i hverdagen.
...
:::{.text-center}
![QR-kode til churn-dashboard](images/churn_dashboard_qr.png){width=10%}
:::

![Efter login mødes konsulenten af en oversigt over churn-relaterede nøgletal og fordelingsgrafer. Denne forside fungerer som et hurtigt overblik over medlemsstatus, risikoprofil og udviklingstendenser blandt virksomhederne.](images/Dash_frontpage.png){ width=80% fig-align="center" }

## Simulation

Simulationsmodulet gør det muligt for konsulenten at indtaste oplysninger om en hypotetisk virksomhed og straks få et estimat på sandsynligheden for churn. Det giver værdi i dialog med nye eller potentielle medlemmer, da konsulenten kan synliggøre deres risikoprofil ud fra relevante karakteristika såsom antal ansatte, branche, postnummer og interaktionshistorik. Værktøjet kan dermed anvendes som beslutningsstøtte i rådgivningssamtaler, ved vurdering af outreach-strategi eller i forbindelse med onboarding af nye medlemmer, hvor det er relevant at forudse behov og risici.

![Simulationsmodulet i dashboardet giver mulighed for at estimere churn-risiko for en hypotetisk virksomhed ud fra bl.a. størrelse, branche, kontakt- og eventhistorik. Brugeren får et visuelt og numerisk estimat på risikoen og tilhørende anbefalinger.](images/Dash_simulation.png){ width=80% fig-align="center" }

## Indsigt

Indsigtsmodulet giver konsulenten mulighed for hurtigt at filtrere medlemsvirksomheder baseret på churn-sandsynlighed, risikoniveau, branche, virksomhedstype og postnummer. Dette gør det nemt at identificere medlemmer med høj risiko for churn og skabe målrettede indsatser. Værktøjet er særligt nyttigt i daglig drift, hvor konsulenten kan prioritere sin indsats og kontakte de mest udsatte virksomheder først. Eksempelvis dem med størst sandsynlighed for at churne i fremtiden.

![Indsigtsmodulet giver overblik over churn-sandsynligheden (churn_prob) for hver virksomhed og gør det muligt at filtrere og identificere de virksomheder med størst risiko for udmeldelse.](images/Dash_indsigt.png){ width=80% fig-align="center" }

## Detaljer

Detaljemodulet viser en dybdegående profil af en enkelt virksomhed og samler al relevant information ét sted. Her kan konsulenten se virksomhedens bidrag, medlemskabslængde, historik, kontaktstatus og anbefalede next steps. Churn-risikoen præsenteres sammen med konkrete strategiske handlinger, såsom invitation til event, opfølgende møde eller personlig kontakt. Modulet fungerer som en praktisk forberedelse før dialog og giver et klart billede af virksomhedens situation.

![Detaljevisningen giver et samlet overblik over en specifik medlemsvirksomhed med fokus på churn-risiko, kontaktstatus og strategiske anbefalinger. Her fremgår både virksomhedens økonomiske bidrag, churn-analyse og foreslåede call-to-action for konsulenten.](images/Dash_detaljer.png){ width=80% fig-align="center" }

## Indsigt og analyse

Analysemodulet visualiserer churn-sandsynlighed på tværs af virksomheder og gør det muligt at identificere tendenser og mønstre – fx hvilke postnumre, brancher eller virksomhedstyper der har højest gennemsnitlig risiko. For konsulenten er det et redskab til strategisk overblik og prioritering. Det kan eksempelvis bruges til at målrette kampagner eller identificere strukturelle forhold, der kræver særlige indsatser – både på kort og lang sigt.

![Visualiseringer, der hjælper konsulenten med hurtigt at identificere risikoområder og målrette indsatsen mod brancher, postnumre eller virksomhedstyper med høj churn-sandsynlighed.](images/Dash_indsigt_analyse.png){ width=80% fig-align="center" }
...
# Konklusion
Projektet har vist, hvordan Business Viborg med et afgrænset datagrundlag og begrænsede ressourcer kan anvende machine learning som et konkret værktøj til medlemsfastholdelse. Gennem analyse af 2.966 medlemsvirksomheder og systematisk afprøvning af seks modeller blev der udviklet en forklarlig Random Forest-model med stærke prædiktive egenskaber (F1 = 0,79, AUC = 0,93). Modellen er operationaliseret i et interaktivt dashboard, som giver medlemskonsulenterne og ledelse et datadrevet grundlag for at prioritere og målrette deres opsøgende indsats.
...
## Bilag 1–7: Eksplorativ dataanalyse

Anvendt i forbindelse med udarbejdelse og forståelse af datasættet:

- **Bilag 1:** Fordeling af medlemmer hos Business Viborg  
  *(filnavn: `EDA_1_fordeling_medlemmer.png`)*
  
- **Bilag 2:** Eventdeltagelse blandt aktive medlemmer  
  *(filnavn: `EDA_2_eventdeltagelse.png`)*
  
- **Bilag 4:** Branchefordeling blandt aktive medlemmer  
  *(filnavn: `EDA_4_branchefordeling.png`)*
  
- **Bilag 5:** Eventdeltagelse pr. postnummer  
  *(filnavn: `EDA_5_eventdeltagelse_postnummer.png`)*
  
- **Bilag 6:** Korrellationsmatrix for numeriske variable  
  *(filnavn: `EDA_6_korrellationsmatrix.png`)*
  
- **Bilag 7:** Mødelængde vs. eventdeltagelse  
  *(filnavn: `EDA_7_mødelængde_eventdeltagelse.png`)*

## Bilag 8–16: Modeludvikling og evaluering

Anvendt i forbindelse med udvikling og evaluering af ML-modeller:

- **Bilag 8:** Model performance (Accuracy, F1 og ROC AUC)  
  *(filnavn: `1_model_performance.png`)*
  
- **Bilag 9:** Top 10 vigtigste variabler pr. model  
  *(filnavn: `4_top_10_variabler_pr_model.png`)*
  
- **Bilag 10:** Sammenlignende heatmap over modeller
  *(filnavn: 3_heatmap_pr_model.png)*
  
- **Bilag 11:** Udvikling over tid – churn-risiko
  *(filnavn: 2_linje_plot.png)*
	
- **Bilag 12:** Brancher med højest churn-rate
  *(filnavn: 5_brancher_højeste_churn.png)*
  
- **Bilag 13:** Postnumre med højest churn-rate
  *(filnavn: 6_postnummer_højeste_churn.png)*

- **Bilag 14:** Top 5 segmenter som ikke churner
  *(filnavn: 7_top5_der_ikke_churner.png)*

- **Bilag 15:** Churn-risikokategorier for aktive kunder
  *(filnavn: 9_churn_risikokategorier_aktive.png)*

- **Bilag 16:** Top 10 variable i Random Forest modellen
  *(filnavn: 8_top_10_variable_rf.png)*

## Bilag 17: Adgang til interaktivt churn-dashboard

Som led i projektet er der udviklet et interaktivt dashboard, der visualiserer churn-risiko og centrale medlemsdata. Dashboardet er udviklet i R Shiny og gør det muligt at filtrere, prioritere og analysere medlemmer med henblik på fastholdelse.
...
:::{.text-center}
![QR-kode til churn-dashboard](images/churn_dashboard_qr.png){width=20%}
:::
...
churn_recipe <- 
  ...
  update_role(PNumber, new_role = "ID") |>  # PNumber bevares, men bruges ikke som predictor
...
# -------------------------------------------------------------------------
# 9.4 Plot for xgboost og Random forest med de vigtigste variabler 
# -------------------------------------------------------------------------
