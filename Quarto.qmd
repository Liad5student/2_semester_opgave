...
# ------------------------------------------------------------------------------
# 2.5: Splits NACECode i kode og beskrivelse, fjern original kolonne og NA-rækker
# ------------------------------------------------------------------------------
merged_unique <- merged_unique |>
  mutate(
...
# ------------------------------------------------------------------------------
# 4.1: Opretter en ny variabel, der beregner hvor mange år 
...
# ------------------------------------------------------------------------------
# 4.2: Rensning af Employees-kolonnen (antal ansatte). 
...
# ------------------------------------------------------------------------------
# 4.3: Oversættelse af virksomhedstyper til mere læsbare formater
...
# ------------------------------------------------------------------------------
# 4.4: Tilføj branchebetegnelse baseret på NACE-koder
...
# ------------------------------------------------------------------------------
# 4.5: Opretter 2. feature/variabel – har virksomheden haft kontakt?
...
# ------------------------------------------------------------------------------
# 4.6:# Trin 6: Opretter 3. feature/variabel – har virksomheden deltaget i event?
...
# ------------------------------------------------------------------------------
# 4.7: Skaber kategorier der viser virksomhedens behov for hjælp
...
# Hvis virksomheden har søgt hjælp til strategi/emner som forretningsidé, produkt osv.
...
# ------------------------------------------------------------------------------
# 4.8: Behold kun aktive virksomheder
# ------------------------------------------------------------------------------
feature_engineering <- feature_engineering |> 
...
# ------------------------------------------------------------------------------
# 4.10: Konverter udvalgte kolonner til faktorer, 
...
# ------------------------------------------------------------------------------
# 4.11: Gem det færdigbehandlede datasæt til senere analyse eller modellering
# ------------------------------------------------------------------------------
