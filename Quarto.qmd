...
{\large \textbf{2. interne eksamensprojekt}} \\
...
{\large \textbf{Antal tegn: xx.xxx + Shiny App}}
...
# Konklusion
Projektet har vist, hvordan Business Viborg med et afgrænset datagrundlag og begrænsede ressourcer kan anvende maskinlæring som et konkret værktøj til medlemsfastholdelse. Gennem analyse af 2.966 medlemsvirksomheder og systematisk afprøvning af seks modeller blev der udviklet en forklarlig Random Forest-model med stærke prædiktive egenskaber (F1 = 0,71, AUC = 0,86). Modellen er operationaliseret i et interaktivt dashboard, der giver medlemskonsulenterne et datadrevet grundlag for at prioritere og målrette deres opsøgende indsats.

Resultaterne peger entydigt på, at fravær af kontakt, manglende eventdeltagelse og manglende erhvervshjælp er tæt knyttet til udmeldelse. Samtidig viser analysen, at en langvarig relation og relationel dybde – målt gennem fx mødelængde – hænger tæt sammen med fastholdelse. Denne indsigt skaber en direkte kobling mellem data og daglig praksis i medlemsarbejdet.
...
-   Bilag 2: Fordeling af medlemmer hos Business Viborg
(filnavn: EDA_1_fordeling_medlemmer.png)

-   Bilag 3: Antal år som medlem (boksplot)
(filnavn: EDA_2_antal_år_medlem.png)

-   Bilag 4: Fordeling af antal år som medlem
(filnavn: EDA_3_fordeling_antal_år.png)

-   Bilag 5: Eventdeltagelse blandt aktive medlemmer
(filnavn: EDA_4_eventdeltagelse.png)

-   Bilag 6: Hjælpetyper hos aktive medlemmer der ikke deltager i events
(filnavn: EDA_6_deltager_ikke_events.png)

-   Bilag 7: Hjælpetyper hos aktive medlemmer der deltager i events
(filnavn: EDA_6_1_deltager_i_events.png)

-   Bilag 8: Branchefordeling blandt aktive medlemmer
(filnavn: EDA_7_branchefordeling.png)

-   Bilag 9: Eventdeltagelse fordelt på branche
(filnavn: EDA_8_eventdeltagelse_branche.png)

-   Bilag 10: Hjælpekategorier fordelt på branche
(filnavn: EDA_9_hjælpekategorier_branche.png)

-   Bilag 11: Eventdeltagelse pr. postnummer
(filnavn: EDA_10_eventdeltagelse_postnummer.png)

-  	Bilag 12: Gennemsnitlig mødelængde pr. branche
(filnavn: EDA_11_mødelængde.png)

-   Bilag 13: Mødelængde vs. eventdeltagelse
(filnavn: EDA_12_mødelængde_eventdeltagelse.png)

-   Bilag 14: Mødelængde vs. medlemsstatus
(filnavn: EDA_13_mødelængde_medlemsstatus.png)

-   Bilag 15: Fordeling af mødelængder
(filnavn: EDA_14_fordeling_mødelængder.png)

-   Bilag 16: Korrellationsmatrix for numeriske variable
(filnavn: EDA_15_korrellationsmatrix.png)

Modelvisualiseringer

Anvendt i forbindelse med udvikling og evaluering af maskinlæringsmodeller:

-   Bilag 17: Model performance (Accuracy, F1 og ROC AUC)
(filnavn: 1_model_performance.png)

-   Bilag 18: Top 10 vigtigste variabler pr. model
