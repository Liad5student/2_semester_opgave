...
![Geografisk afstand fra Viborgs centrum ser ud til at spille en rolle i udmeldelsestendens.](images/6_postnummer_højeste_churn.png){ width=80% fig-align="center" }
...
Seks maskinlæringsmodeller blev afprøvet: Support Vector Machine (SVM), XGBoost, Random Forest, logistisk regression, K-nearest Neighbors (KNN) og Naive Bayes.

![Figuren illustrerer variationen i modellernes styrker på tværs af metrikker.](images/1_model_performance.png){ width=80% fig-align="center" }
...
![Farveintensitet viser performance – mørkere felter angiver højere score. Random Forest og SVM scorer generelt højt, mens Naive Bayes udviser lav F1-score.](images/3_heatmap_pr_model.png){ width=80% fig-align="center" }
...
![Eventdeltagelse, mødelængde og antal ansatte er blandt de mest betydningsfulde prædiktorer for churn.](images/8_top_10_variabler_rf.png){ width=80% fig-align="center" }
...
# ------------------------------------------------------------------------------
# 5.14 Gem EDA-resultat som RDS-fil til senere brug
# ------------------------------------------------------------------------------

saveRDS(featured, "data/eda.rds")
```
