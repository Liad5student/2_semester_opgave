# --------------------------------------------------------------
# Indlæs alle .rds-filer fra tidligere branches via helperen
# --------------------------------------------------------------
...
preprocessed_data   <- get_rds_from_branch("6.-Preprocessing", "preprocessing.rds")
model_results       <- get_rds_from_branch("7.-Modelling", "modelling.rds")
